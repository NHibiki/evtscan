...
import { tablizeGroup } from '~/lib/util';
...
export const actions = {
    async updateData({ commit, state }) {
        let recvData = (await getDetail("group", state.id)).data.data;
        let [data, detailedData, detailedActions, metaData] = tablizeGroup(recvData);
