...
<script>
    ...
    export default {
        ...
        asyncData({store, route, isServer}) { store.commit('nonfungibletoken/resetData', route.params.id); let promise = store.dispatch('nonfungibletoken/updateData'); if (isServer) return promise; },
        methods: {
